...
var FaviconProviderDefaults = (_a = {},
    _a[FaviconProvider.DUCKDUCKGO] = [
...
function setDataUrlForFavicon(hostname, stylesheet, providerPrecedence, onComplete, throttleMs, fallbackDataUrl) {
    ...
    var inner = function (providerIndex) {
        ...
        testDataUrl(PROXY_URL + faviconUrl, function (dataUrl) { return !FaviconProviderDefaults[provider].includes(dataUrl); }, function (dataUrl) {
